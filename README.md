...
Neste post veremos a preparação da aplicação backend 
que será desenvolvida ao longo do curso prático de criação 
de uma API de Vendas com Node.js, Typescript, TypeORM, Docker e muito mais.

## Iniciar a aplicação Node.js com Typescript
``` yarn init -y ``` 


Fazer a instalação do Typescript na pasta do projeto, como uma dependência de 
desenvolvimento. Como o código final é convertido para javascript antes de ser 
disponibilizado online, só precisaremos do Typescript em ambiente de desenvolvimento.
